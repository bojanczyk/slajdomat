...
.chronicle-sound-list-item > :first-child {
    width: 30px;
}

.chronicle-sound-list-item > :nth-child(2) {
    width : 150px;
    white-space: nowrap;
    overflow: hidden;
...
#alert-box > div {
    ...
    background-color: var(--very-light-blue);
    font-size: large;
}`, "",{"version":3,"sources":["webpack://./src/viewer/css/viewer.css"],"names":[],"mappings":"AAAA;IACI,qBAAqB;MACnB,qBAAqB;IACvB,wBAAwB;IACxB,yBAAyB;IACzB,gBAAgB;IAChB,sBAAsB;IACtB,2BAA2B;EAC7B;;AAEF;IACI,aAAa;IACb,gBAAgB;AACpB;;AAEA;IACI,qBAAqB;IACrB,gBAAgB;IAChB,eAAe;AACnB;;AAEA;IACI,wCAAwC;IACxC,mCAAmC;IACnC,kBAAkB;IAClB,eAAe;AACnB;;AAEA;IACI,UAAU;AACd;;;AAGA;IACI,kBAAkB;IAClB,OAAO;IACP,aAAa;IACb,WAAW;IACX,aAAa;IACb,mBAAmB;IACnB,YAAY;IACZ,eAAe;AACnB;;AAEA;IACI,kBAAkB;IAClB,WAAW;IACX,YAAY;AAChB;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,0BAA0B;AAC9B;;AAEA;IACI,aAAa;AACjB;;AAEA,yCAAyC;AACzC;IACI,kBAAkB;AACtB;;AAEA;IACI,mBAAmB;IACnB,UAAU;IACV,WAAW;AACf;;AAEA;IACI,aAAa;AACjB;;;;AAIA;IACI,aAAa;AACjB;;AAEA;IACI,gBAAgB;IAChB,SAAS;IACT,WAAW;IACX,YAAY;IACZ,aAAa;IACb,mBAAmB;IACnB,UAAU;IACV,UAAU;IACV,qCAAqC;AACzC;;AAEA;IACI,UAAU;IACV,oCAAoC;AACxC;;AAEA;IACI,WAAW;IACX,YAAY;IACZ,aAAa;IACb,oBAAoB;IACpB,kBAAkB;IAClB,aAAa;IACb,mBAAmB;IACnB,uBAAuB;IACvB,wCAAwC;IACxC,gBAAgB;AACpB","sourcesContent":[":root {\n    --grafitowy : #2c2c2c;\n      --niebieski : #18A0FB;\n    --select-color : #daebf7;\n    --disabled-color : Silver;\n    --blue : #4646FF;\n    --light-blue : #B4C8FF;\n    --very-light-blue : #DCE6FF;\n  }\n\nbody, html {\n    height : 100%;\n    overflow: hidden;\n}\n\nbody, div, button, input, textarea {\n    font-family: 'Roboto';\n    font-weight: 200;\n    font-size: 12px;\n}\n\nbutton { \n    background-color: var(--very-light-blue);\n    border : 1px solid var(--niebieski);\n    border-radius: 3px;\n    cursor: pointer;\n}\n\nbody {\n    margin : 0;\n}\n\n\n#upper-panel {\n    position: absolute;\n    top : 0;\n    bottom : 20px;\n    width :100%;\n    display: flex;\n    flex-direction: row;\n    flex-grow: 1;\n    flex-shrink : 1;\n}\n\n.hidden-svg {\n    position: absolute;\n    width : 0px;\n    height : 0px; \n}\n\n#svg-container {\n    flex-grow : 1;\n    flex-direction: column;\n    /* align-items : center; */\n}\n\n#svg { \n    flex-grow : 1;\n}\n\n/* this counters a display bug in figma */\npath:not([fill]) {\n    fill : transparent;\n}\n\n.sound-icon {\n    position : absolute;\n    color: red;\n    z-index : 2;\n}\n\n.invisible {\n    display: none;\n}\n\n\n\n.hidden {\n    display: none;\n}\n\n#alert-box {\n    position : fixed;\n    top: 20px;\n    width: 100%;\n    height: 40px;\n    display: flex;\n    align-items: center;\n    z-index: 8;\n    opacity: 0;\n    transition : opacity 0.5s ease-in-out;\n}\n\n#alert-box.visible {\n    opacity: 1;\n    transition: opacity 0.5s ease-in-out;\n}\n\n#alert-box > div {\n    width: 100%;\n    height: 100%;\n    margin : 10px;\n    /* rounded corners */\n    border-radius: 5px;\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    background-color: var(--very-light-blue);\n    font-size: large;\n}"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
const startedAnimations = new Map();
...
function runOverlay(overlay, direction, silent) {
    ...
    switch (overlay.type) {
        ...
        case 'animate':
            if (direction == 'forward')
                animationParams = loadSVG_1.afterParams.get(overlay);
            else
                animationParams = loadSVG_1.beforeParams.get(overlay);
            duration = 1;
            break;
        case 'child':
            duration = 0.3;
    ...
    let target = Object.assign(Object.assign({ duration: duration }, animationParams), { onComplete: complete });
    gsap_1.gsap.to(svg, target);
}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.isRootOpen = exports.timelineFailedLoad = exports.userAlert = exports.updateTimeLineForCurrent = exports.updateTimeCounter = exports.timelineSeen = exports.timelineRecording = exports.timelineHTML = exports.removeLoading = exports.progressCache = exports.openPanelTreeRec = exports.openPanelTree = exports.markSeen = exports.markDisabled = exports.initPanels = void 0;
const gsap_1 = __webpack_require__(/*! gsap */ "./node_modules/gsap/index.js");
...
function timelineHTML() {
    ...
    if ((Object.keys(viewer_1.manifest.treeTimeLine).length > 0)) {
...
function timelineFailedLoad(frame) {
    const div = progressCache[frame];
    div.classList.add('nosound');
}
exports.timelineFailedLoad = timelineFailedLoad;
...
function isRootOpen() {
    return !subtreeDivCache.get(viewer_1.manifest.tree).classList.contains('slide-stack-hidden');
}
exports.isRootOpen = isRootOpen;
...
function initLeftPanel() {
    ...
    versionDiv.textContent += 'v' + package_json_1.version;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.cleanRect = exports.cleanDefs = exports.attachSVG = exports.processQueue = exports.finishedLoading = exports.queueError = exports.loadStruct = exports.afterParams = exports.beforeParams = exports.transforms = exports.svgMap = exports.localRect = exports.addToQueue = void 0;
...
const beforeParams = new Map();
exports.beforeParams = beforeParams;
const afterParams = new Map();
...
function finishedLoading(slide, object) {
    try {
        ...
        for (let i = 0; i < slide.children.length; i++) {
            ...
            if (event.type != 'child') {
                const id = event.id;
                const before = (0, animate_params_1.currentParams)(id, i, slide.children, slide.originalParams, 0);
                beforeParams.set(event, before);
                const after = (0, animate_params_1.currentParams)(id, i + 1, slide.children, slide.originalParams, 0);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.initSoundHTML = exports.loadSound = exports.soundAdvance = exports.canPlaySound = exports.endRecording = exports.playAudio = exports.soundIcon = exports.startRecording = exports.stopSound = exports.soundState = exports.initSoundTimeline = exports.loadNearbySounds = void 0;
const viewer_1 = __webpack_require__(/*! ./viewer */ "./src/viewer/viewer.ts");
const files_1 = __webpack_require__(/*! ./files */ "./src/viewer/files.ts");
const html_1 = __webpack_require__(/*! ./html */ "./src/viewer/html.ts");
const timeline_1 = __webpack_require__(/*! ./timeline */ "./src/viewer/timeline.ts");
...
let mediaRecorder;
function liveOrtree() {
    const radio = document.getElementById('chronicle-record-mode');
    if (radio.checked)
        return 'live';
    else
        return 'tree';
                    ...
                    try {
                        ...
                        if (serverResponse.status != 'sound recorded')
                        ...
                        else if (soundState == 'none') {
                            {
                                ...
                                viewer_1.manifest.treeTimeLine = man.treeTimeLine;
            ...
            if (sound.audio != undefined)
                ...
                return new Promise((resolve, reject) => {
                    ...
                    audio.onerror = (e) => {
                        ...
                        timeline_1.timeline.frames[index].soundFile = undefined;
                        timeline_1.timeline.frames[index].audio = undefined;
                        timeline_1.timeline.frames[index].soundDuration = undefined;
                        (0, html_1.timelineHTML)();
                        resolve(undefined);
                    };
                });
...
function whenFinishedPlaying() {
    return __awaiter(this, void 0, void 0, function* () {
        if (timeline_1.timeline.current < timeline_1.timeline.frames.length - 1) {
            if (!canPlaySound(timeline_1.timeline.current + 1))
                stopSound();
...
// ************ html for sounds ***************
function showChronicleRecordings() {
    const liveRecordings = document.getElementById('list-of-chronicle-sounds');
    if (viewer_1.manifest.chronicleTimeLine == undefined || viewer_1.manifest.chronicleTimeLine.length == 0) {
        liveRecordings.innerHTML = 'The chronicle is empty';
        return;
    }
    for (const live of viewer_1.manifest.chronicleTimeLine) {
        const state = (0, timeline_1.decodeState)(live.state);
        if (state != undefined) {
            const div = document.createElement('div');
...
function initSoundHTML() {
    ...
    // soundIcon();
    const liveRecordingRadio = document.getElementById('chronicle-record-mode');
    const treeRecordingRadio = document.getElementById('tree-record-mode');
    ...
    const soundRecordingDiv = document.getElementById('sound-recording-mode');
    const displayChronicleRadio = document.getElementById('display-chronicle-mode');
    const displayTreeRadio = document.getElementById('display-tree-mode');
    if ((0, viewer_1.treeOrChronicleURL)() == 'chronicle') {
    ...
    displayChronicleRadio.addEventListener('change', () => {
        if (displayChronicleRadio.checked) {
            displayTreeRadio.checked = false;
            (0, timeline_1.changeTimelineMode)('chronicle');
    ...
    displayTreeRadio.addEventListener('change', () => {
        if (displayTreeRadio.checked) {
            displayChronicleRadio.checked = false;
            (0, timeline_1.changeTimelineMode)('tree');
    ...
    if (viewer_1.manifest.chronicleTimeLine == undefined || viewer_1.manifest.chronicleTimeLine.length == 0) {
        ...
        const chronicleLabel = document.getElementById("display-chronicle-mode-container");
        chronicleLabel.classList.add('disabled');
    }
    showChronicleRecordings();
}
exports.initSoundHTML = initSoundHTML;
...
function createTimeline(mode) {
    ...
    if (mode == 'chronicle') {
        for (const item of viewer_1.manifest.chronicleTimeLine) {
        ...
        (0, sound_1.initSoundTimeline)('live');
    }
    else {
        createTimelineFromEvents(viewer_1.manifest.tree);
        (0, sound_1.initSoundTimeline)('tree');
    }
}
...
function changeTimelineMode(mode) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const searchParams = url.searchParams;
        if (mode == 'chronicle') {
            if (viewer_1.manifest.chronicleTimeLine.length > 0) {
                const firstState = viewer_1.manifest.chronicleTimeLine[0].state;
                yield gotoState(decodeState(firstState));
...
exports.changeTimelineMode = changeTimelineMode;
...
function findBug(state, direction) {
    if (state.type == 'start' && state.slide.parent == undefined && direction == 'backward') {
...
function runState(state, direction, mode) {
    if (state.type == 'start') {
...
function gotoIndex(index, mode = 'animated', soundTime) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        else if (sound_1.soundState == 'recording') {
        ...
        if (sound_1.soundState == 'recording') {
            (0, sound_1.startRecording)();
        }
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.treeOrChronicleURL = exports.userAgent = exports.serverConnected = exports.prevButton = exports.playButton = exports.nextButton = exports.manifest = exports.getManifest = void 0;
...
exports.treeOrChronicleURL = treeOrChronicleURL;
...
module.exports = /*#__PURE__*/JSON.parse('{"name":"slajdomat","productName":"Slajdomat","version":"3.1.0","description":"Software to make slides in figma","main":".webpack/main","scripts":{"start":"electron-forge start","package":"electron-forge package","make":"webpack && electron-forge make ","publish":"electron-forge publish","lint":"eslint --ext .ts,.tsx .","webpack":"webpack","watch":"webpack --watch","postbuild":"echo dupa"},"keywords":[],"author":{"name":"Mikolaj Bojanczyk","email":"mbojanczyk@gmail.com"},"license":"MIT","devDependencies":{"@electron-forge/cli":"^7.3.0","@electron-forge/maker-deb":"^7.2.0","@electron-forge/maker-rpm":"^7.2.0","@electron-forge/maker-squirrel":"^7.2.0","@electron-forge/maker-zip":"^7.2.0","@electron-forge/plugin-auto-unpack-natives":"^7.2.0","@electron-forge/plugin-webpack":"^7.2.0","@figma/plugin-typings":"^1.82.0","@types/jsdom":"^21.1.6","@types/multer":"^1.4.11","@types/pdfkit":"^0.13.3","@types/source-map-support":"^0.5.10","@types/webfontloader":"^1.6.38","@typescript-eslint/eslint-plugin":"^5.62.0","@typescript-eslint/parser":"^5.62.0","@vercel/webpack-asset-relocator-loader":"^1.7.3","css-loader":"^6.8.1","electron":"28.1.0","eslint":"^8.56.0","eslint-plugin-import":"^2.29.1","file-loader":"^6.2.0","fork-ts-checker-webpack-plugin":"^7.3.0","hook-shell-script-webpack-plugin":"^0.4.0","html-loader":"^4.2.0","html-webpack-plugin":"^5.6.0","node-loader":"^2.0.0","path-browserify":"^1.0.1","pdfkit":"^0.14.0","style-loader":"^3.3.3","ts-loader":"^9.5.1","ts-node":"^10.9.2","typescript":"~4.5.4","url-loader":"^4.1.1","webpack-cli":"^5.1.4"},"dependencies":{"@types/cors":"^2.8.17","@types/svg-to-pdfkit":"^0.1.3","axios":"^1.6.5","cors":"^2.8.5","electron-squirrel-startup":"^1.0.0","fuse.js":"^7.0.0","gsap":"^3.12.4","jsdom":"^24.0.0","multer":"^1.4.5-lts.1","node-record-lpcm16":"^1.0.1","source-map-support":"^0.5.21","svg-to-pdfkit":"^0.1.8"},"browser":{"path":false,"stream":false}}');
